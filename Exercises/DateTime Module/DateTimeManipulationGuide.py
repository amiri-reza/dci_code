...
d1 = datetime.datetime.today()   # this shows current date and time in a datetime object
...
d4 = d3.strftime('%Y-%d-%B %H:%M:%S')   # format the datetime object according to our formatting (gives back in string type)
...
d8 = datetime.date(year=2000, month=1, day=11)     # datetime instance, (year, month and day are 'keys')
